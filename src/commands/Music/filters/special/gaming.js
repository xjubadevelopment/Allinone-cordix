...
class GamingFilterCommand extends Command {
        constructor() {
                super({
                        name: "gaming",
   ...
   },
   {
      ...
      gain: 0.1
                        ...
                        return this._reply(context, this._createSuccessContainer("Gaming"));
                } catch (error) {
                        return this._reply(
                                context,
                                this._createErrorContainer("Could not apply the gaming filter."),
                        );
                }
        }
        ...
        _createSuccessContainer(filterName) {
                ...
                const content =
                        ...
                        `└─ **${emoji.get("info")} Effect:** Enhanced for gaming music\n\n` +
...
export default new GamingFilterCommand();